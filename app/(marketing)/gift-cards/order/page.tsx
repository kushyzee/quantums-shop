...
export default async function GiftCardOrderPage() {
  const [catalogItems, bankAccounts] = await Promise.all([
    listCatalogPublic("giftcard"),
  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-8 px-4 py-12">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-semibold">Order a Gift Card</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Choose a gift card, confirm payment, and we&rsquo;ll deliver it
          shortly.
        </p>
      </div>
